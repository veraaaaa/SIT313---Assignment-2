...
namespace Assignment2
{
    ...
    {
        List<CustomerInfo> LoginList = RegisterPage.NewCustomerList;
        ...
        public LoginPage()
        {
            ...
            async void LoginBtn_clicked(object sender, EventArgs e)
            {
                ...
                foreach(var i in LoginList)
                {
                    ...
                    if (i.email.Equals(inputemail) && i.PassWord!=inputpassword)
                    {
                ...
                else 
                {
                    ...
                    {
                        await DisplayAlert("Alert", "We can not find your account, please register", "OK");
                        await Navigation.PushAsync(new RegisterPage());
                    }
                    else if ((inputemail == ""))
                    {
