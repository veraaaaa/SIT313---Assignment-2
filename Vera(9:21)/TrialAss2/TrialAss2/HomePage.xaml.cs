...
namespace TrialAss2
{
    public partial class HomePage : ContentPage
    {
        ...
        public ObservableCollection<HomeCell> list { get; set; }

        public HomePage()
        {
            InitializeComponent();
            list = new ObservableCollection<HomeCell>();
        ...
        //{
        //    base.OnAppearing();
        //    postSection.ItemsSource = await App.MyDatabase.GetAllInfo();
        //}
        ...
        //    {
        //        await Navigation.PushAsync(new AddPostPage { BindingContext = e.SelectedItem as PostInfo });
        //    }
        }
    }
